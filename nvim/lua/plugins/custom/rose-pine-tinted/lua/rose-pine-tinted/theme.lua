...
function M._load(options)
    ...
    M.defaults = {
        ...
        DiagnosticStatusLineError = { fg = groups.error },
        DiagnosticStatusLineHint = { fg = groups.hint },
        DiagnosticStatusLineInfo = { fg = groups.info },
        DiagnosticStatusLineWarn = { fg = groups.warn },
